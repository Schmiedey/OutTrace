...
export const USAGE_EVENTS = ["consent-enabled", "product-opened", "manual-scan", "first-scan", "second-scan", "returned-day-7", "watchlist-added", "share-card-exported", "digest-delivered", "upgrade-opened"] as const;
