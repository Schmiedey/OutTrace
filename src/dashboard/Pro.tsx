...
export function ProPage() {
  ...
  return <div className="mx-auto max-w-4xl px-10 py-10">
    ...
    <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-mute">Manual scans, graphs, scores, and single-scan exports stay free. Pro adds the ongoing monitoring and multi-site reporting that make LinkScope useful every day.</p>
    <div className="mt-10 grid gap-4 md:grid-cols-2"><Plan name="Free" price="$0" items={["Unlimited manual scans", "Score, explanation, and full graph", "Branded share cards + single-scan export", "Saved scans and complete local backups"]} /><Plan name="Pro" price="$14.99 once" items={["One-time payment — access remains active", "Unlimited watched sites", "Daily or weekly background checks", "Native digests, change alerts, and deep audits", "Multi-site history reporting + bulk export"]} highlighted /></div>
